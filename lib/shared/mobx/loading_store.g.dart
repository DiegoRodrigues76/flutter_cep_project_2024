...
mixin _$LoadingStore on _LoadingStore, Store {
  late final _$isLoadingAtom =
      Atom(name: '_LoadingStore.isLoading', context: context);
  ...
  late final _$_LoadingStoreActionController =
      ActionController(name: '_LoadingStore', context: context);

  @override
  void setLoading(bool value) {
    final _$actionInfo = _$_LoadingStoreActionController.startAction(
        name: '_LoadingStore.setLoading');
    try {
